...
export const categoryServiceShapes: ServiceShapes = {
  ...
  enums: new Set([]),
  types: {
  CategoryData: [{ n:"id", t:"number" }, { n:"name", t:"string" }, { n:"parentCategory", t:"CategoryData", c:1 }, { n:"subCategoryList", t:"SubCategoryList", c:1 }, { n:"attributeList", t:"CategoryAttributeList", c:1 }, { n:"metadata", t:"PagingData", c:1 }],
  SubCategoryData: [{ n:"id", t:"number" }, { n:"name", t:"string" }, { n:"subCategoryList", t:"SubCategoryList", c:1 }],
  SubCategory: [{ n:"id", t:"number" }, { n:"name", t:"string" }, { n:"lastModifiedDate", t:"string" }],
  ParentCategoryData: [{ n:"id", t:"number" }, { n:"name", t:"string" }, { n:"parentCategory", t:"ParentCategory", c:1 }],
  ParentCategory: [{ n:"id", t:"number" }, { n:"name", t:"string" }],
