...
export const orderServiceShapes: ServiceShapes = {
  ...
  OrderItemData: [{ n:"id", t:"number" }, { n:"stockKeepingUnitId", t:"number" }, { n:"productSellerCode", t:"string" }, { n:"price", t:"number" }, { n:"sellerDiscount", t:"number" }, { n:"mallDiscount", t:"number" }, { n:"commission", t:"number" }, { n:"status", t:"number" }, { n:"quantity", t:"number" }, { n:"productName", t:"string" }, { n:"deliveryFeeType", t:"number" }, { n:"dueAmount", t:"number" }, { n:"shipmentInfo", t:"OrderItemShipmentInfo", c:1 }, { n:"attributes", t:"SkuAttributeList", c:1 }, { n:"customTextOptionValues", t:"CustomTextOptionsDataList", c:1 }, { n:"bundle", t:"boolean" }, { n:"updatedDate", t:"string" }, { n:"cargoCompanyWarning", t:"string" }, { n:"approvedDate", t:"string" }, { n:"installmentChargeWithVAT", t:"number" }, { n:"productId", t:"number" }, { n:"sellerCouponDiscount", t:"number" }, { n:"sellerInvoiceAmount", t:"number" }, { n:"sellerStockCode", t:"string" }, { n:"shipmenCompanyCampaignNumber", t:"string" }, { n:"shippingDate", t:"string" }, { n:"sppApproved", t:"boolean" }, { n:"totalMallDiscountPrice", t:"number" }, { n:"version", t:"number" }],
